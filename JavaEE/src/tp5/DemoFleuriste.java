...
public class DemoFleuriste {
	...
	public static void main(String[] args) {
		Fleur fleur1 = new Fleur("Rose", (float) 6.0, 3);
		Fleur fleur2 = new Fleur("Arum", (float) 2.1, 12);
		Fleur fleur3 = new Fleur("Hortensia", (float) 3.5, 45);
		Fleur fleur4 = new Fleur("Jasmin", (float) 6.2, 6);
		Fleur fleur5 = new Fleur("Anémone", (float) 3.0, 20);
